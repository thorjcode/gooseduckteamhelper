...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__A6D79DE",
    appName: "gooseduckteamhelper",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
const pages = [
  {
    ...
    style: {
      navigationBarTitleText: "鹅鸭杀组队助手",
      enablePullDownRefresh: true
    }
  },
  {
    path: "pages/createTeam/createTeam",
    style: {
  ...
  {
    path: "pages/myTeamDetail/myTeamDetail",
    style: {
      navigationBarTitleText: "我的队伍详情",
      enablePullDownRefresh: false
    }
  },
  {
...
const subPackages = [
  {
    ...
    pages: [
      {
        path: "backstageHome/backstageHome",
        style: {
          navigationBarTitleText: "后台首页",
          enablePullDownRefresh: false
        }
      },
      {
      ...
      {
        path: "addHeadImg/addHeadImg",
        style: {
          navigationBarTitleText: "添加头像",
          enablePullDownRefresh: false
        }
      },
      {
        path: "addTeamType/addTeamType",
        style: {
          navigationBarTitleText: "添加队伍类型",
          enablePullDownRefresh: false
        }
      },
      {
        path: "addGameMode/addGameMode",
        style: {
          navigationBarTitleText: "添加游戏模式",
          enablePullDownRefresh: false
        }
      },
      {
        path: "addGameMap/addGameMap",
        style: {
          navigationBarTitleText: "添加游戏地图",
          enablePullDownRefresh: false
        }
      },
      {
      ...
      {
        path: "addMeTopBg/addMeTopBg",
        style: {
          navigationBarTitleText: "添加我的页面背景",
          enablePullDownRefresh: false
        }
      },
      {
...
const globalStyle = {
  ...
  navigationBarTitleText: "鹅鸭杀组队助手",
  navigationBarBackgroundColor: "#403873",
...
const k = true, I = "mp-weixin", C = b([]), A = I, P = b('{\n    "address": [\n        "127.0.0.1",\n        "192.168.1.4"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), E = b('[{"provider":"aliyun","spaceName":"duckdev","spaceId":"mp-03fe1f0f-7f8a-4957-9869-6fe45e570b5a","clientSecret":"CFXKc5Zq88+F/PAhsAxMaw==","endpoint":"https://api.next.bspapp.com"}]') || [];
let x = "";
try {
  x = "__UNI__A6D79DE";
} catch (e2) {
