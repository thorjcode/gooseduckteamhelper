  ...
  methods: {
    ...
    addImg() {
      ...
      common_vendor.Ls.uploadFile({
        ...
        if (res.success) {
          db.collection("SysGameMap").add({
            mapName: this.inputValue,
            mapImg: res.fileID
          }).then((res2) => {
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/uniapp-project/gooseduckteamhelper/pages/backstage/addGameMap/addGameMap.vue"]]);
